...
### LiPo Charging and Balancing

{% embed url="https://www.youtube.com/watch?pp=ygUVTElwbyBiYWxhbmNlIGNoYXJnaW5n&v=k1j1-FBgS3A" %}

* **Always use a balance charger:** Ensures each cell is charged evenly, preventing overcharge and extending battery life.
...
### Balance Charging Steps

1. Connect power and balance connectors to the charger.
2. Set charger to Balance Charge mode and select battery type.
3. Double-check connections, start charging, and monitor the process.
4. The charger will balance all cells, improving battery health and safety.
