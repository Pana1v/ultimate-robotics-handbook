...
For background: in my current work I maintain a multimodal EKF state estimator that fuses 3D ICP scan matches with IMU and wheel encoders at high frequency. The pattern is roughly:
